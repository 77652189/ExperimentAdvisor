"""Legacy E. coli / HMO standard GP-BO (qNEI) page.

Split out of App/app.py. Historical path -- underlying data has been confirmed
invalid (see README.md); kept for reference and demoted to a secondary sidebar
option behind the Pichia hLF workflow.
"""
